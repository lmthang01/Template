                                    ...
                                    <table id="dataTable3" class="text-center table-business">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><span class="status-p bg-primary">Đã đặt cọc</span></td>
                                                <td>24/05/2023 16:00</td>
                                                <td>???</td>
                                                <td>???</td>
                                                <td>
                                                    <ul class="d-flex justify-content-center">
                                                        <li class="mr-2"><a href="../Contract/infoContract.php" class="text-primary"><i class="fa fa-info-circle" aria-hidden="true"></i></a></li>
                                                        <li class="mr-2"><a href="../Contract/editContract.php" class="text-primary"><i class="fa fa-edit"></i></a></li>
