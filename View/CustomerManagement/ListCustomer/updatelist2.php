                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" value="KHACH HANG QT" id="example-text-input">
                                        </div>
                                        <div class="form-group">
                                            <label for="example-search-input" class="col-form-label">MÔ TẢ</label>
                                            <input class="form-control" type="text" value="Khách hàng quan tâm đếm sp, cần tư vấn thêm">
                                        </div>
