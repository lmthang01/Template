                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Cập Nhật Danh Sách Khách Hàng</span></li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="col-10 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <button onclick="window.location.href='../../View/List/listcustomer.php'" type="button" class="btn btn-outline-dark mt-3">Hủy </button>
                                            <!-- </a> -->
