                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" value="customer_refered" id="example-text-input">
                                        </div>
                                        <div class="form-group">
                                            <label for="example-search-input" class="col-form-label">MÔ TẢ</label>
                                            <input class="form-control" type="text" value="khách hàng được loyal giới thiệu">
                                        </div>
