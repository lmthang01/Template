                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="../Contact/contact.php">Liên hệ với khách hàng</a></li>
                                    ...
                                    <div class="card-body">
                                        <div class="card-header-order">
                                            ...
                                            <div class="btn-group-head-order">
                                                ...
                                                <button onclick="window.location.href='../Contact/personContact.php'" type="button" class="btn btn-addorder btn-back">Trở về</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="head-product-contact">
                                            ...
                                            <div class="btn-load">
                                                <button type="button" class="btn btn-xs btn-outline-dark mb-3 mt-3" ><i class="ti-plus"></i> Chọn Hàng Hóa</button>
                                            </div>
                                        </div>
