                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            ...
                            <div class="head-title-addbtn">
                                    <h4 class="header-title">Người liên hệ</h4>
                                    <!-- AddNew & OtherOptions Btn -->
                                    <div class="head-title-btn">
                                        <a href="../../View/Lienhe/addcontact.php">
                                            ...
                                            <tr>
                                                ...
                                                <td>          
                                                    <div class="dropdown col-lg-6 col-md-4 col-sm-6">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="../../View/Lienhe/addcontact.php">Thêm mới</a>
                                                            <a class="dropdown-item" href="../../View/Lienhe/updatecontact.php">Cập nhật</a>
