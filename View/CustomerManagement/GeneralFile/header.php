...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="../srtdash/../srtdash/assets/images/icon/favicon.ico">
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="index.php"><img src="../srtdash/assets/images/icon/logo.png" alt="logo"></a>
                </div>
            </div>
            <div class="main-menu">
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
                                        <table class="dbkit-table">
                                            ...
                                            <tr>
                                                <td class="mv-icon"><img src="../srtdash/assets/images/icon/market-value/icon1.png" alt="icon">
                                                </td>
                                            ...
                                            <tr>
                                                <td class="mv-icon">
                                                    <div class="mv-icon"><img src="../srtdash/assets/images/icon/market-value/icon2.png" alt="icon"></div>
                                                </td>
                                                <td class="coin-name">LiteCoin</td>
                                                <td class="buy">30% <img src="../srtdash/assets/images/icon/market-value/triangle-down.png" alt="icon"></td>
                                                <td class="sell">20% <img src="../srtdash/assets/images/icon/market-value/triangle-up.png" alt="icon"></td>
                                                <td class="trends"><img src="../srtdash/assets/images/icon/market-value/trends-down-icon.png" alt="icon"></td>
                                                <td class="attachments">$ 56746,857</td>
                                                <td class="stats-chart">
                                            ...
                                            <tr>
                                                <td class="mv-icon">
                                                    <div class="mv-icon"><img src="../srtdash/assets/images/icon/market-value/icon3.png" alt="icon"></div>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="mv-icon">
                                                    <div class="mv-icon"><img src="../srtdash/assets/images/icon/market-value/icon4.png" alt="icon"></div>
                                                </td>
