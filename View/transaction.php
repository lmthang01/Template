                            ...
                            <div class="card-body">
                                <div class="head-title-addbtn">
                                    ...
                                    <div class="head-title-btn">
                                        <a href="../View/addnewTransaction.php">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <ul class="d-flex justify-content-center">
                                                        <li class="mr-2"><a href="../View/infoTransaction.php" class="text-primary"><i class="fa fa-info-circle" aria-hidden="true"></i></a></li>
                                                        <li class="mr-2"><a href="../View/editTransaction.php" class="text-primary"><i class="fa fa-edit"></i></a></li>
